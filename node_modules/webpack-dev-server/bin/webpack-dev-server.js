...
var optimist = require("optimist")
	...
	.describe("port", "The port").default("port", 83)

	.describe("public", "The public hostname/ip address of the server")//.default("host", "68.129.174.11")

	.describe("host", "The hostname/ip address the server will bind to").default("host", "127.0.0.1");
...
function processOptions(wpOpt) {
	...
	if(argv.host !== "127.0.0.1" || !options.host)
		options.host = argv.host;

	if(argv.public)
		options.public = argv.public;

	if(argv.port !== 83 || !options.port)
